...
Declare two variables, productName for the product name and pricePerItem for storing the price per item. 
When declaring, assign the following product characteristics to the variables:
